...
const Navbar = ({ logo }) => {
  ...
  return (
    <div className="flex flex-row items-center justify-between h-28 bg-blue-900">
...

      {
        ...
        <div ref={wrapperRef} className="absolute top-0 w-full h-48 bg-white">
          ...
          <div className="flex flex-col items-center justify-around h-full pt-5">
            <a onClick={() => setOpenNav(false)} href="/" className="text-lg font-semibold text-blue-800 transition-all hover:text-green-400">Home</a>
            ...
            <a onClick={() => setOpenNav(false)} href="#contact" className="text-lg font-semibold text-blue-800 transition-all hover:text-green-400">Contact</a>
          </div>
        </div>
      }
      ...
      <div className="flex justify-around w-1/5 mr-12 lg:visible sm:invisible">
        <a href="#home" className="text-lg font-semibold text-white transition-all hover:text-green-400">Home</a>
        {/* <a href="#product" className="text-lg font-semibold text-white transition-all hover:text-orange-500">Product</a> */}
        {/* <a href="#faq" className="text-lg font-semibold text-white transition-all hover:text-orange-500">Faq</a> */}
        <a href="#contact" className="text-lg font-semibold text-white transition-all hover:text-green-400">Contact</a>
      </div>
